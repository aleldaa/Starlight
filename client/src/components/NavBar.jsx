        ...
        <nav className="navbar">
            <div className="header">
                <div className='main-title'>
                    <img onClick={handleClick} className='logo' src="/images/starry-night.png"/>
                    <div className="navbar-elements">
                            <NavLink to="/home" className='navLink'>
                                <img className="home-icon" src='/images/home.png'/>
                            </NavLink>
                            ...
                            <NavLink to='/friends' className='navLink'>
                                <img className="friends-icon" src="/images/learning.png"/>
                            </NavLink>
                            ...
                            <NavLink to='/notifications' className='navLink'>
                                <img className="notif-icon" src="/images/bell.png"/>
                            </NavLink>
                    </div>
                    <div className="logout-button">
                        <NavLink onClick={handleLogout} to='/logout' className='logoutlink'>
                            <img src="/images/logout.png" className="logout-icon"/>
                        </NavLink>
                    </div>
                </div>
            </div>
